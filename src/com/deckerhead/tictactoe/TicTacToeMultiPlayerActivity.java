/*
 * The Android Activity for a multiplayer tic-tac-toe game.
 * @Author Deckerhead Developers
 * Sunday, July 1, 2012
 */
...
public class TicTacToeMultiPlayerActivity extends Activity {

	/*
	 * Static values for the players.
	 * Player one is always a human.
	 * Player two is either a human or a computer player.
	 * In this case, it is a human.
	 */
	...
	// Who's turn it is.
	private boolean turn = PLAYER_ONE;

	// The player weapons.
	private int playerOneWeapon;
	private int playerTwoWeapon;
	...
	public int getPlayerOneWeapon() {
		/*
		 * Gets the first player's weapon.
		 */
		return playerOneWeapon;
	}
	public int getPlayerTwoWeapon() {
		/*
	...
	// The grid locations.
	ImageButton[][] locations = new ImageButton[3][3];
	...
	public void checkBoardAndUpdateAll() {
		// TODO add comment
